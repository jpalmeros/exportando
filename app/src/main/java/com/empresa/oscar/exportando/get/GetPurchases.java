...
public class GetPurchases extends AsyncTask<Void, Void, ArrayList> {
    private ProgressDialog progressDialog;
    private HttpClient httpClient;
    private HttpPost httpPost;
    private ArrayList<Purchase> listaPurchases;
    ...
    protected ArrayList doInBackground(Void... arg0) {
        String response;
        String aux;
        listaPurchases=new ArrayList<Purchase>();
        try {
            httpClient = new DefaultHttpClient();
            httpPost = new HttpPost("http://crisoldeideas.com/exporta/api_layer/getPurchases.php");
            ...
            for (int i = 0; i < purchases.length(); i++) {
                ...
                int purchase_id=purchase.getInt("purchase_id");
                int purchase_amount=purchase.getInt("purchase_amount_unit");
                ...
                listaPurchases.add(new Purchase(provider_name,product_name,purchase_date,purchase_amount,purchase_id));
            }
