 ...
 */
public class PostStorageReception extends AsyncTask<Void, Void, String> {
    ...
    PostStorageReception(Activity context, int purchase_id, int code_id, String serial, int user_id, int amount,int location_id) {
